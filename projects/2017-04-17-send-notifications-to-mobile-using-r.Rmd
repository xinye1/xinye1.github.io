---
title: Send Notifications to Mobile using R
author: Xinye Li
date: '2017-04-17'
...
Categories:
  ...
  - productivity
menu: projects
description: 'A quick post to demostrate scheduling of mobile phone notifications using R'
---
...
<img src="img/r_notifications/pb_phone.png" alt="pb_phone" width="500">

And download the browser extension to set up on the computer:

<img src="img/r_notifications/pb_computer.png" alt="pb_computer" width="500">
...
<img src="img/r_notifications/pb_account.png" alt="pb_computer" width="500">
...
<img src="img/r_notifications/notification.png" alt="notification" width="500">
